<template>
    ...
    <footer class="pt-8 pb-6 footer text-gray-light bg-light">
        
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-md-6 col-lg-4 mb-6 mb-md-0">
                    <a class="d-block mb-2" href="#">
                       Product Feeback Tool
                    </a>
                    ...
                    <form>
                        <div class="input-group input-group-lg mb-6">
                            <input type="email" required name="email"
                                class="form-control  bg-white border-0 z-index-1" placeholder="Your email">
            ...
            <div class="mt-0 mt-md-10 row">
                ...
                <p class="col-md-auto mt-4 mt-md-0">
                    © Prodcut Feedback Tool. All Rights Reserved
                </p>
            </div>
        </div>
    </footer>
