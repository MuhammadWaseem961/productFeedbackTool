(function ($) {
  ...
  var APP = {
    ...
    dropdownMenuMobile: function () {
      $ (
        ".main-header .dropdown-menu [data-toggle='dropdown']"
      ...
      $slider.each (function () {
        ...
        options.slide = function (event, ui) {
          if (options.type === 'currency') {
            $this
              ...
              .find ('.amount')
              .val (
                format.format (ui.values[0]).toString ().replace ('$', ' PKR ' + '') +
                  ' to ' +
                  format.format (ui.values[1]).toString ().replace ('$', ' PKR ' + '')
              );
          }
        ...
        if (options.type === 'currency') {
          $this
            ...
            .val (
              format
                .format ($this.slider ('values', 0))
                .toString ()
                .replace ('$', ' PKR ' + '') +
                ' to ' +
                format
                  .format ($this.slider ('values', 1))
                  .toString ()
                  .replace ('$', ' PKR ' + '')
            );
        }
